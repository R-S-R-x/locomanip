...
@configclass
class AGOZ1WBCEnvCfg(LeggedManipLabEnvCfg):
    ...
    def __post_init__(self):
        ...
        # scene
        self.scene.robot: ArticulationCfg = AGO_Z1_CFG.replace(
        ...
        # rewards
        self.rewards.track_base_height_exp.params["target_height"] = 0.36
...
class AGOZ1WBCEnvCfg_PLAY(AGOZ1WBCEnvCfg):
