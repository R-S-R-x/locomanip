...
# from LeggedManip_Lab.assets.go2_arx_austin1.go2arm_articulation_cfg import GO2ARM_CFG
# from LeggedManip_Lab.assets.go2_arx_austin.go2_arx5_articulation_cfg import GO2_ARX5_CFG

from LeggedManip_Lab.tasks.manager_based.leggedmanip_lab.leggedmanip_lab_env_cfg import *


@configclass
class Go2ARX5FlatEnvCfg(LeggedManipLabEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()

        # scene
        self.scene.robot: ArticulationCfg = GO2_ARX5_CFG.replace(
