...
current_dir = os.path.dirname(os.path.abspath(__file__))
B2_PIPER_USD = os.path.join(current_dir, "b2_piper.usda")
...
B2PIPER_LEG_JOINT_NAMES = B2PIPER_JOINT_NAMES[:12]
B2PIPER_ARM_JOINT_NAMES = B2PIPER_JOINT_NAMES[12:]
B2PIPER_POLICY_JOINT_NAMES = B2PIPER_JOINT_NAMES[:18]
...
B2_PIPER_CFG = ArticulationCfg(
    ...
    actuators={
        ...
        # The six arm joints are actuated. Gripper joints 7/8 intentionally stay passive.
        "arm_joint1": DelayedPDActuatorCfg(
        ...
        "gripper": DelayedPDActuatorCfg(
            joint_names_expr=["arm_joint7", "arm_joint8"],
            stiffness=100.0,
            damping=1.0,
            armature=0.01,
            min_delay=0,
