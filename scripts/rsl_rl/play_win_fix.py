...
if os.name == "nt":
    os.environ.setdefault("ISAACLAB_DISABLE_HDF5", "1")
...
parser = argparse.ArgumentParser(description="Play with a trained RL agent using RSL-RL.")
...
# Disable h5py import to avoid DLL issues on Windows
os.environ["ISAACLAB_DISABLE_HDF5"] = "1"
